                                      ...
                                      <div class="modal-body">
                                          <form role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-lg-10">
                                                      <input type="email" placeholder="" id="skills" name="to" class="form-control" multiple>
                                                      <!-- <datalist id="emails">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-lg-10">
                                                      <input type="email" placeholder="" id="skills2" name="cc" class="form-control" multiple autocomplete="on">
                                              ...
                                              <div class="form-group">
                                                  <div class="col-lg-offset-2 col-lg-10">
                                                      ...
                                                      <button class="btn btn-send" type="submit" name="create">Send</button>
                                                  </div>
                                              </div>
                                          </form>
                                      </div>
